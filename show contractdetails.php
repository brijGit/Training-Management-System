...
<img src="images/ongc1.jpg" align = "left"/>
  ...
  <tr>
	...
	<?php 
	 ...
	 $query="UPDATE contractdetails SET flag='0' WHERE cname='".$id."'";
		
		  if(!mysql_query($query,$link))
		  {die ("An unexpected error occured while <b>deleting</b> the record, Please try again!");}
		  else
		 {
		  echo "<script language='javascript'>alert('Company Contract details deleted');</script>";}
	 ?>
    <?php 
	 	 $link=mysql_connect("localhost","root","") or die("Cannot Connect to the database!");
...
<div id="footer">
	 <h4 align="center"><a href="contractdetails.php" title="Go Back" target="_parent">Go Back</a></h4>
