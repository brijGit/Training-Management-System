...
<title>Database of Problem Details</title>
...
<img src="images/ongc1.jpg" align = "left"/>
  ...
  <h3 align = "center">Database of Problem Details</h3>
...
while($result=mysql_fetch_array($resource))
 ...
 <div id="footer">
	<h4 align="center"><a href="r_update1.php" title="Go Back" target="_parent">Go Back</a><br />
