...
<img src="images/ongc1.jpg" align = "left"/>
 ...
 <h4 align="right"><a href="Assistant Head.php" title="Back to homepage" >Home</a></h4>  
  ...
  <table align="center" cellpadding="0" bgcolor="#FFFFFF" width="700" border="2">
  <tr>
    <td>
	<?php 
	 $id=$_REQUEST['cpf']; 
	 ...
	 $query="UPDATE nominations SET flag='0' WHERE cpf='".$id."'";
		
		  if(!mysql_query($query,$link))
		  {die ("An unexpected error occured while <b>deleting</b> the record, Please try again!");}
		  else
		 {
		  echo "<script language='javascript'>alert('Nomination deleted');</script>";}
	 ?>
...
while($result=mysql_fetch_array($resource))
	...
	<a href=\"show nomi.php?cname=".$result[0]."\"><img border=\"0\" src=\"images/cooltext457952800.png\" onmouseover=\"this.src='images/cooltext457952800MouseOver.png';\" onmouseout=\"this.src='images/cooltext457952800.png';\" /></a>
	</td></tr>";
	} echo "</table>";
 ...
 <div id="footer">
	<h4 align="center"><a href="nominations.php" title="Go Back" target="_parent">Go Back</a></h4>
