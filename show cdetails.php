 ...
 <h4 align="right"><a href="admin.php" title="Back to homepage" >Home</a></h4>  
  ...
  <tr>
	...
	<?php 
	 ...
	 $query="UPDATE cdetails SET flag='0' WHERE pkID='".$id."'";
		
		  if(!mysql_query($query,$link))
		  {die ("An unexpected error occured while <b>deleting</b> the record, Please try again!");}
		  else
		 {
		  echo "<script language='javascript'>alert('Company details deleted');</script>";}
	 ?>
...
while($result=mysql_fetch_array($resource))
 ...
 <div id="footer">
	<h4 align="center"><a href="cdetails.php" title="Go Back" target="_parent">Go Back</a></h4>
