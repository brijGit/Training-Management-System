...
echo "<script language='javascript'>alert('You have succesfully logged out');</script> ";
 ?>
<?php
	...
	$validate=sprintf("select *
								from users 
								where  status='%s' && pass='%s'&& username='%s'",mysql_real_escape_string($pass2),mysql_real_escape_string($pass),mysql_real_escape_string($pass1))or die("cannot find");
